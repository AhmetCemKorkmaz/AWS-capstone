...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cejkw2alwxq1.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstoneahmetcemblog' # please enter your s3 bucket name
